      ...
      <nav id="sidebar" className="sidebar js-sidebar">
        <div className="sidebar-content js-simplebar">
          ...
          <ul className="sidebar-nav">
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link" to="/certificate/list">
                <i className="align-middle" data-feather="sliders"></i>{" "}
                <span className="align-middle">Certificates</span>
              </Link>
            </li>
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link" to="/settings/leave-type">
                <i className="align-middle" data-feather="sliders"></i>{" "}
                <span className="align-middle">Leave Type</span>
              </Link>
            </li>
            <li className="sidebar-item">
            ...
            <li className="sidebar-item">
              <Link className="sidebar-link" to="/leave-details">
                <i className="align-middle" data-feather="sliders"></i>{" "}
                <span className="align-middle">Leave Details</span>
              </Link>
            </li>

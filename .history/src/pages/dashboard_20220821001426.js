                  ...
                  <div className="col-sm-6">
                    <div className="card">
                      <div className="card-body">
                        ...
                        <div className="mb-0">
                          <div>Total Leave:  10 </div>
                          <div>Taken Leaave:  3 </div>
                          <div>Left Leave:  7 </div>
                        </div>
                      </div>
                    </div>
                    <div className="card">
                      <div className="card-body">
                        <div className="row">
                          <div className="col mt-0">
                            <h5 className="card-title">Paternity Leave</h5>
                          </div>
                        </div>
                        <div className="mb-0">
                          <div>Total Leave:  10 </div>
            ...
            <div className="col-xl-6 col-xxl-7">
              <div className="card flex-fill w-100">
                <div className="card-header">
                  ...
                  <h5 className="card-title mb-0">Recent Leave</h5>
                </div>

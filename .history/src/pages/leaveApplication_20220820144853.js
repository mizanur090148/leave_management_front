...
function LeaveApplication() {
  ...
  const [ccStatus, setCc] = useState(false);
  const [bccStatus, setBcc] = useState(false);
              ...
              <div className="card">
                <div className="card-body">
                  <div class="pb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" className="form-control" onChange={setTo(this.state.value)} placeholder="Input" defaultValue={'mizanur090148@gmail.com'} />
                    </div>
                  </div>
                  <div class="pb-3 row">
                  ...
                  { bcc && 
                    <div class="pb-3 row">
                      <label for="inputPassword" class="col-sm-2 col-form-label">Bcc</label>
                      <div class="col-sm-10">
                        <Select
                            closeMenuOnSelect={false}
                            components={animatedComponents}
